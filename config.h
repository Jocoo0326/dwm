...
static const char *const autostart[] = {
    "st",
    NULL,
    "/home/jocoo/Configs/home_dotfiles/.scripts/time",
    NULL,
    "/home/jocoo/Configs/home_dotfiles/.scripts/wallpaper",
    NULL,
    "/home/jocoo/Configs/home_dotfiles/.scripts/compton.sh",
    NULL,
    "fcitx-autostart",
    NULL,
    NULL /* terminate */
...
static const char *voldowncmd[] = {"amixer", "-q",  "set",
                                   "Master", "5%-", NULL};
static const char *volmutecmd[] = {"amixer", "-q",     "set",
                                   "Master", "toggle", NULL};
